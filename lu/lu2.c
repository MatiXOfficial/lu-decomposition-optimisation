// 2: Put loop counters and frequently used values A and N in registers
...
int main(int argc, const char* argv[])
{
    ...
    if (argc == 1)
    {
        sprintf(fileName, "results/lu2_results.txt");
    }
    else
    {
        sprintf(fileName, "results/lu2_results_%s.txt", argv[1]);
    }
